...
public final class Configuration {
    ...
    public static class Builder {
         ...
         */
        public Builder setMin(final int min) { // NOPMD ignore
            this.min = min;
            return this;
        }
         ...
         * @return this builder, for method chaining
         */
        public Builder setMax(final int max) { // NOPMD ignore
            this.max = max;
            return this;
        }
         ...
         * @return this builder, for method chaining
         */
        public Builder setAttempts(final int attempts) { // NOPMD ignore
            this.attempts = attempts;
            return this;
        }
